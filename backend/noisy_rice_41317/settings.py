"""
Django settings for noisy_rice_41317 project.
...
ROOT_URLCONF = 'noisy_rice_41317.urls'
...
WSGI_APPLICATION = 'noisy_rice_41317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_rice_41317 API",
    "DESCRIPTION": "API documentation for noisy_rice_41317 App",
    "VERSION": "v1",
}
